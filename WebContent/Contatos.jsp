...
<body>
  ...
  <form name="formulario" method="post" action="">
    ...
    <div class="Instituicao">
      <label for="instituicao">Instituição (universidade/escritório):</label><br>
      <input type="text" name="instituicao"
             id="instituicao" tabindex="1" autofocus="" placeholder="Informe sua instituição" size=47 />
    </div>
    ...
    <p>* Preenchimento de campos obrigatório</p>
