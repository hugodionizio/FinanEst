			...
			<div align="center">
				...
				<div>
					<label for="usuario">Usuário:</label><br> <input type="text"
						name="usuario" id="usuario" tabindex="1" autofocus=""
				...
				<br> <input type="submit" name="sub" value="Cadastrar-se" /> <input
					type="submit" name="sub" value="Entrar" /> <input
					class='recuperarSenha' type="button" onclick="recuperarSenha()"
					value='Recuperar Senha' /><br>
				<br>
